...
data = pd.read_csv('results/einsum_benchmark_comparison_shapes.csv')
...
data = data.round(3)
data.to_csv('results/einsum_benchmark_comparison_final.csv', index=False, columns=['Tensor contraction', 'Tensor shapes', 'Matrix shapes', 'Naive', 'AVX2', 'OMP', 'BLAS', 'NumPy'])
