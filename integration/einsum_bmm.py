# Code from Git repository: https://github.com/jcmgray/einsum_bmm
# But with bmm line changed to use our library bmm function
...
def einsum(eq, a, b=None, *, fast=True, backend=None):
