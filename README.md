...
1. Create Simple `C++` library
2. Wrap python library arround
3. Support `numpy.array` data transfer
4. Write tensor contraction tests
5. Implement basic functionallity
6. Run bottleneck analysis to establish engineering cycle
7. Improve implementation
8. Compare performance with `numpy.einsum`
